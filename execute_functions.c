...
/**
  * print_prompt - Printing the prompt to the user
  */
...
/**
  * read_input - Reading the input from users
  *
  * Return: Char variable to the program
  */
...
/**
  * execute_command - Executing input from the buffer
  * @input: Arg from the buffer
  * @argv: Array of arg
  * @env: Environment var
  */
...
/**
  ...
  * @args: Arg to the built in commands
